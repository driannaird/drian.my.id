...
const WorkTogetherSection = () => {
  return (
    <section className="bg-bg-partial p-8 mt-3 rounded-md lg:m-5">
      ...
      <div className="mt-4">
        <button className="bg-gradient-to-r from-unggu-is to-pink-is py-2 px-4 rounded-md border border-border-me flex justify-center items-center gap-1 text-base transition-all duration-300 ease-in-out hover:opacity-80 md:text-lg">
          Hubungi Saya
        </button>
      </div>
    </section>
