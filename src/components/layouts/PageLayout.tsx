  ...
  return (
    <div className="p-3 lg:px-32 lg:py-8">
      <div className="container mx-auto bg-gradient-to-br from-slate-gradient-one to-black rounded-lg border border-border-me lg:grid lg:grid-cols-4 lg:bg-none lg:border-none lg:gap-4">
        ...
        <header className="m-3 lg:col-span- lg:m-0 transition-all duration-300 ease-in-out relative z-50">
          <Navbar />
        </header>
        <main className="m-3 text-white lg:col-span-3 lg:mt-0 transition-all duration-300 ease-in-out">
          {children}
        </main>
      </div>
    </div>
